...
class RunnerBase:
    ...
    def dataloaders(self) -> dict:
        ...
        if self._dataloaders is None:
            ...
            for dataset in datasets:
                ...
                # collate_fns.append([d for d in dataset])
    ...
    def setup_output_dir(self):
        ...
        output_dir = lib_root.parent / self.config.run_cfg.output_dir
        ...
        os.system('cp -r %s %s' % (self.config.args.cfg_path, self.output_dir))
        os.system('cp -r %s %s' % ('./minigpt4', self.output_dir))
