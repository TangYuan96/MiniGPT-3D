...
class TraditionalMetricEvaluator():
    def __init__(self, inputs, output_dir, output_file):
        ...
        self.sbert_model = SentenceTransformer("./params_weight/all-mpnet-base-v2")
        # self.sbert_model = SentenceTransformer('all-mpnet-base-v2')

        self.simcse_tokenizer = AutoTokenizer.from_pretrained("./params_weight/sup-simcse-roberta-large")
        # self.simcse_tokenizer = AutoTokenizer.from_pretrained("princeton-nlp/sup-simcse-roberta-large")

        self.simcse_model = AutoModel.from_pretrained("./params_weight/sup-simcse-roberta-large")
